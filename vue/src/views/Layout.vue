<template>
  <div >
    ...
    <div style="flex: 1;text-align: right; padding-right:20px">
      ...
      <span class="el-dropdown-link" style="cursor: pointer">{{admin.username}}<i class="el-icon-arrow-down el-icon--right"></i></span>
  ...
  <div style="display:flex">
    <!--侧边栏导航-->
    <div style = " width : 200px; overflow: hidden; margin-right: 2px;background-color: white;min-height: calc(100vh - 62px) ;">
